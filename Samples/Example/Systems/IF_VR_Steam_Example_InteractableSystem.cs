...
using UniRx;
using InterVR.IF.VR.Plugin.Steam.Example.Components;
using EcsRx.Unity.Extensions;
using InterVR.IF.VR.Plugin.Steam.InteractionSystem;
using UnityEngine;
using UniRx.Triggers;

namespace InterVR.IF.VR.Plugin.Steam.Example.Systems
{
    public class IF_VR_Steam_Example_InteractableSystem : ISetupSystem, ITeardownSystem
    {
        public IGroup Group => new Group(typeof(IF_VR_Interactable), typeof(IF_VR_Steam_Example_Interactable));
        ...
        public void Setup(IEntity entity)
        {
            ...
            var exampleInteractable = entity.GetComponent<IF_VR_Steam_Example_Interactable>();
