...
using InterVR.IF.VR.Plugin.Steam.Examples.Throwing.Installer;
using UnityEngine;

namespace InterVR.IF.VR.Plugin.Steam.Examples.Throwing
{
    [DefaultExecutionOrder(-20000)]
    public class IF_VR_Steam_Example_Throwing_ApplicationBehaviour : IF_ApplicationBehaviour
    {
        ...
        {
            var settings = Container.Resolve<IF_VR_Steam_Example_Throwing_Installer.Settings>();
