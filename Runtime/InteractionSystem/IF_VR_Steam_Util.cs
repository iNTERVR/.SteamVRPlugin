...
{
	//-------------------------------------------------------------------------
	public static class IF_VR_Steam_Util
	{
		...
		{
			IF_VR_Steam_AfterTimer_Component afterTimer_component = go.AddComponent<IF_VR_Steam_AfterTimer_Component>();
	...
	//-------------------------------------------------------------------------
	[System.Serializable]
	public class IF_VR_Steam_AfterTimer_Component : MonoBehaviour
	{
