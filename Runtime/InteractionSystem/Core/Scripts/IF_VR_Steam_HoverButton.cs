...
namespace InterVR.IF.VR.Plugin.Steam.InteractionSystem
{
    ...
    public class IF_VR_Steam_HoverButton : MonoBehaviour
    {
        ...
        public IF_VR_Steam_HandEvent onButtonDown;
        public IF_VR_Steam_HandEvent onButtonUp;
        public IF_VR_Steam_HandEvent onButtonIsPressed;
        ...
        private IF_VR_Steam_Hand lastHoveredHand;
