...
{
    public class IF_VR_Steam_HandPhysics : MonoBehaviour
    {
        [Tooltip("IF_VR_Steam_Hand collider prefab to instantiate")]
        public IF_VR_Steam_HandCollider handColliderPrefab;
        [HideInInspector]
        public IF_VR_Steam_HandCollider handCollider;
