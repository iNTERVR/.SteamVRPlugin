...
//
// Purpose: IF_VR_Steam_Interactable that can be used to move in a circular motion
//
//=============================================================================
...
namespace InterVR.IF.VR.Plugin.Steam.InteractionSystem
{
	...
	public class IF_VR_Steam_CircularDrive : MonoBehaviour
	{
		public enum Axis_t
		{
			XAxis,
		...
		[Tooltip( "A IF_VR_Steam_LinearMapping component to drive, if not specified one will be dynamically added to this GameObject" )]
		...
		[Tooltip( "If true, the path of the IF_VR_Steam_Hand (red) and the projected value (green) will be drawn" )]
		...
		private IF_VR_Steam_Hand handHoverLocked = null;
        ...
        private IF_VR_Steam_GrabTypes grabbedWithType;
		//-------------------------------------------------
		...
		//-------------------------------------------------
		// Updates the IF_VR_Steam_LinearMapping value from the angle
		//-------------------------------------------------
